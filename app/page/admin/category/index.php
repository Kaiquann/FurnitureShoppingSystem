...
<ul>
    ...
    <li>
        <a href="/admin/category/trash">Trashed Category</a>
    </li>
</ul>
...
<ul>
    ...
    <li>
        <button data-confirm="Are you sure to delete all the selected category?" form="select-form"
            class="select-btn danger">Delete</button>
    </li>
</ul>
...
<form action="/admin/category/delete" method="post" id="select-form"></form>
    ...
    <tbody>
        ...
        <?php foreach ($arr as $c) : ?>
            <tr>
                ...
                <td>
                    <button data-get="/admin/category/update?id=<?= $c->id ?>" class="success">Update</button>
                    <button data-post="/admin/category/delete?id=<?= $c->id ?>"
                        data-confirm="Are you sure to delete <?= html_print($c->name) ?>?" class="danger">Delete</button>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
