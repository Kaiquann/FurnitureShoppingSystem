...
<ul>
    ...
    <li>
        <a href="/admin/user/blocked">Blocked User</a>
    </li>
    <li>
        <a href="/admin/user/deleted">Deleted User</a>
    </li>
</ul>
...
<ul>
    ...
    <li>
        ...
        <button type="button" data-message="Are you sure to apply the selected batch action?" form="select-form"
            data-action="/admin/user/update_role" class="select-btn select-submit-btn primary">Apply</button>
    </li>
    <li>
        <button type="button" data-message="Are you sure to block all the selected users?" form="select-form"
            data-action="/admin/user/block" class="select-btn select-submit-btn warning">Block</button>
    </li>
    <li>
    ...
    <tbody>
        ...
        <?php foreach ($arr as $u) : ?>
            <tr>
                ...
                <td><?= $u->created_at ?></td>
                <td>
                    <button data-get="/admin/user/view?id=<?= $u->id ?>" class="primary">View</button>
                    <button data-get="/admin/user/update?id=<?= $u->id ?>" class="success">Update</button>
                    <button data-post="/admin/user/block?id=<?= $u->id ?>"
                        data-confirm="Are you sure to block <?= html_print($u->email) ?>?" class="warning">Block</button>
