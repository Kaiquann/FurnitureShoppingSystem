...
<ul>
    ...
    <li>
        <button type="button" data-message="Are you sure to recover all the selected users?" form="select-form"
            data-action="/admin/user/recover" class="select-btn select-submit-btn warning">Recover</button>
    </li>
    <li>
        <button type="button" data-message="Are you sure to permanent delete all the selected users?" form="select-form"
            data-action="/admin/user/permanent_delete" class="select-btn select-submit-btn danger">Delete</button>
    </li>
</ul>
        ...
        <?php foreach ($arr as $u) : ?>
            <tr>
                ...
                <td>
                    ...
                    <button data-post="recover?id=<?= $u->id ?>"
                        data-confirm="Are you sure to recover <?= html_print($u->email) ?>?"
                        class="warning">Recover</button>
                    <button data-post="permanent_delete?id=<?= $u->id ?>"
                        data-confirm="Are you sure to permanent delete <?= html_print($u->email) ?>?"
