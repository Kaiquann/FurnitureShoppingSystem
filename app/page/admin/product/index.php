...
<ul>
    ...
    <li>
        <a href="/admin/product/trash">Trashed Product</a>
    </li>
    <li>
        <a href="/admin/product/low_stock">Low Stock Product</a>
    </li>
</ul>
...
<table class="table detail">
    ...
    <tbody>
        <?php if (empty($arr)) : ?>
            <tr>
                <td colspan="<?= count($fields) + 1 ?>">No record found</td>
            </tr>
        <?php endif; ?>
        <?php foreach ($arr as $p) : ?>
            <tr>
                ...
                <td>
                    <button data-get="/admin/product/view?id=<?= $p->id ?>" class="primary">View</button>
                    <button data-get="/admin/product/update?id=<?= $p->id ?>" class="success">Update</button>
